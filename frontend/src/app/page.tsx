  ...
  return (
    <div className="min-h-[600vh]">
      ...
      <div className="fixed inset-0 bg-[#f5f5f5] z-0">
        ...
        {/* Bottom text */}
        <p
          className="absolute bottom-8 left-0 right-0 text-center text-base text-black mix-blend-difference z-10"
          style={{
      ...
      {lastLineGone && (
        <>
          ...
          >
            <a href="/employee" className="block w-full bg-black text-white p-10 hover:bg-black/90 transition-colors">
            ...
            <a href="/admin" className="block w-full bg-black text-white p-10 hover:bg-black/90 transition-colors">
